...
public class UsuarioService {
    ...
    @Autowired
    private com.cocinaapp.repository.AlumnoRepository alumnoRepository;
    ...
    public String iniciarRegistro(String email, String alias) {
        ...
        if (codigoValidacionRepository.existsByMailAndUsadoFalse(email)) {
        ...
        Optional<CodigoValidacion> validacion = codigoValidacionRepository.findByMailAndUsadoFalse(email);
    ...
    public String solicitarRecuperacion(String email) {
        ...
        codigoValidacionRepository.findByMailAndUsadoFalse(email)
